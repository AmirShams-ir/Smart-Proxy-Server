...
install -m 644 config/state.json /etc/sing-box/smarty-state.json
...
install -m 644 systemd/rearm.service /etc/systemd/system/smarty-proxy-rearm.service
install -m 644 systemd/rearm.timer /etc/systemd/system/smarty-proxy-rearm.timer
sed -i 's#/opt/smart-proxy/lib/race.sh#/opt/smart-proxy/lib/race.sh#' /etc/systemd/system/smarty-proxy-rearm.service
...
ln -sf /etc/sing-box/smarty-state.json /opt/smart-proxy/config/state.json
...
systemctl enable --now smarty-proxy-rearm.timer
